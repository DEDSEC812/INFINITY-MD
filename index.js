...
conn.ev.on('connection.update', async (update) => {
 ...
 const botname = "𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘"; //add your name
 const ownername = "𝐒𝐔𝐏𝐏𝐎𝐑𝐓"; // add your name
 const sirius = { 
 key: { 
...
message:{ 
  newsletterAdminInviteMessage: { 
    ...
    newsletterName: "𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘", //add your bot name
    ...
    inviteExpiration: 0
	     ...
	     const username = `Haitian-dev-509`;
...
*│→ 𝐒𝐓𝐀𝐓𝐔𝐒 𝐑𝐄𝐀𝐂𝐓: ${reaction}*╰────────────✑*`;
                    ...
                    await conn.sendMessage(conn.user.id, { 
                        image: { url:'https://files.catbox.moe/ogrpc2.jpg' }, 
			ai: true,
                        caption: upMessage},{
			quoted: sirius
                    });
...
app.get("/", (req, res) => {
    res.send(`
      ...
      <body>
        <div class="card">
          <h1><span class="status-dot"></span>BOT IS RUNNING</h1>
